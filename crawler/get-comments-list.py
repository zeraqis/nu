...
#item = {}
#item['url'] = 'http://www.nu.nl/amsterdam/3960377/ontslag-verduisteren-vijftig-eurocent-mag-van-rechter.html'
#item['id'] = '3960377'
#site = ' site:nujij.nl'
                ...
                if actual_count > 0:
                    ...
                    for i in range(comment_pages):
                        if i == 0:
                            ...
                            comment_status_1=''
                            while comment_status_1 != '200':
                                comment_request = requests.get(nujij_url)
                                comment_status_1 = str(comment_request.status_code)
                        ...
                        if comment_pages > 1:
                            ...
                            comment_status_2=''
                            while comment_status_2 != '200':
                                comment_request = requests.get(comment_urls[i])
                                comment_status_2 = str(comment_request.status_code)
                            ...
                            for li in li_reacties:
                                ...
                                if reactie_body:
                                    ...
                                    if reactie_body.find('span'):
                                        ...
                                        comment_dict['comments'][id_]['replies_to'] = replies
                                        ...
                                        comment_dict['comments'][id_]['comment_body'] = comment_text
                                    else:
                                        comment_text = ' '.join(reactie_body(text=True)).strip()
                                        comment_dict['comments'][id_]['comment_body'] = comment_text
                                    img = li.find('img')
